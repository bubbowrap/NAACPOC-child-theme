...
<div
	...
	<?php endif; ?>
>
	<div class="wp-block-cover alignfull has-nv-dark-bg-background-color has-background-dim">
		<div class="wp-block-cover__inner-container">
			<h1 class="has-text-align-center has-nv-text-dark-bg-color has-text-color">
				<strong><?php echo get_the_archive_title(); ?></strong>
			</h1>
		</div>
	</div>
